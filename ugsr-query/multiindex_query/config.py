...
feature_flags = {
    "debug_mode": False,   # Set to True to enable debug prints (When deploying to production, set to False)
    ...
    "show_title_in_ref": False,    # Set to True to show title in reference section instead of file name
...
share_point_urls = {
    ...
    "all_regions_index": {'name': 'Business Documents All Regions', "url": "https://globalkomatsu.sharepoint.com/sites/NAGMUSGR00243/SitePages/PublishedDocuments.aspx"},
